      ...
      <div className="px-2 pt-3 pb-5">
        ...
        <div className="row mt-5">
          <div className="box col-md-5 px-4 py-4 me-2">
            <img
              src={`http://localhost:8000/public/images/${result.image}`}
          ...
          <div className="box col-md-6 px-4 py-4 ms-2 d-flex flex-column align-items-center justify-content-center">
            ...
            <strong className="my-3 ungu fs-1">Tuberkulosis</strong>
          </div>
        </div>
      ...
      {isOpen &&
        createPortal(
          <ModalVarian
            ...
            imgPath={`http://localhost:8000/public/images/${result.image}`}
          />,
          document.body
        )}
    </Layout>
